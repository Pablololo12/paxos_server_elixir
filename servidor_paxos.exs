    ...
    defp bucle_recepcion() do
        receive do
            ...
            mensajes_prop_y_acept ->
                simula_fallo_mensj_prop_y_acep(mensajes_prop_y_acept,xxx)
        end
    end

    defp espero_escucha() do
        ...
        receive do
            ...
            _resto -> espero_escucha()
        end
    end
    
    defp simula_fallo_mensj_prop_y_acep(Mensaje, xxx) do
        fiable = es_fiable?()
        ...
        if  ((not fiable) and (aleatorio < 200)) do 
            ...
            gestion_mnsj_prop_y_acep(Mensaje,xxx)
        end
    end

    defp gestion_mnsj_prop_y_acep( Mensaje, xxx) do
